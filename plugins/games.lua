...
if not msg.Admin then return "*•* هذا الامر يخص {الادمن,المدير,المنشئ,Owner 🎖} بس" end
...
return "*•* هذا الامر يخص {Owner 🎖,المنشئ} بس" 
end 
...
sendMsg(msg.chat_id_,msg.id_,'*• حلو ، الحين ارسل لي عدد النقاط اللي تبيه*')
end
...
if MsgText[1] == 'كت تويت' or MsgText[1] == 'كت' or MsgText[1] == 'تويت' then
...
return '*• عدد النقاط اللي جمعتها هي » { '..points..' }\n• تقدر تبيع نقاطك وتاخذ (150) رساله مقابل كل جوهره من النقاط *\n'
else
...
if MsgText[2] == "0" then
return '• فيه خطأ ياعيني  \n• لازم يكون البيع ع الاقل 1 من النقاط . 'end
local points = redis:get(max..':User_Points:'..msg.chat_id_..msg.sender_user_id_)
if tonumber(MsgText[2]) > tonumber(points) then
return '• معليش ماعندك نقاط بهذا العدد عشان تقدر تبيعهم' 
end
if points == "0" then
return '• للاسف ماعندك نقاط \n• عشان تجمع نقاط العب وحده من الالعاب الموجوده في `قائمة الالعاب`'
else
