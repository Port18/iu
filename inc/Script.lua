...
return "*•* هذا الامر يخص {المدير,المالك,Owner 🎖} بس "
end
...
if not msg.Creator then return "*•* هذا الامر يخص {المالك,Owner 🎖} بس  "
end
...
if not msg.Admin then return "*•* هذا الامر يخص {الادمن,المدير,المالك,Owner 🎖} بس  "
end
...
if not msg.SudoUser then return "• هذا الامر يخص {Owner 🎖} بس " end
...
if not msg.Admin then return "• هذا الامر يخص {الادمن,المدير,المالك,Owner 🎖} بس  " end
...
if not msg.Admin then return "️*•* هذا الامر يخص {الادمن,المدير,المالك,Owner 🎖} بس " end
...
if not msg.Director then return "*•* هذا الامر يخص {Owner 🎖,المالك,المدير} بس " end
...
if not msg.Creator then return "*•* هذا الامر يخص {Owner 🎖,المالك} بس  " end
if not MsgText[2] and msg.reply_id then
if redis:get(max..'lock:kara:'..msg.chat_id_) == 'off' then
...
if not msg.SudoUser then return "*•* هذا الامر يخص {Dev,Owner 🎖} بس  " end
if not MsgText[2] and msg.reply_id then 
...
if not msg.Kara then return "*•* هذا الامر يخص {المالك الاساسي,Dev,Owner 🎖} بس  " end
if not MsgText[2] and msg.reply_id then
...
if not msg.Kara then return "*•* هذا الامر يخص {Owner 🎖,المالك الاساسي } بس  " end
if not MsgText[2] and msg.reply_id then
...
if not msg.Creator then return "*•* هذا الامر يخص {Owner 🎖,المالك,المدير} بس  " end
...
if not msg.Creator then return "• **هذا الامر يخص {Owner 🎖,المنشئ} فقط  \n" end
...
if not msg.Director then return "*•* هذا الامر يخص {المالك,Owner 🎖} بس  " end
...
if not msg.Creator then return "*•* هذا الامر يخص {المالك,Owner 🎖} بس  " end
...
if not msg.SudoBase then return"*•* هذا الامر يخص {Owner 🎖} بس  " end
...
return "*•* الاذاعه مقفوله من قبل Owner 🎖 🚶" 
end
...
return '-› اصدار سورسنوسترا : *v'..version..'* '
end
...
•[المطور](t.me/XzzzU) ↢ مطور البوت

「[Source Nostra ](https://t.me/XzzzU)」  ]]
...
if not msg.Admin then return "*•* هذا الامر لــ {الادمن,المدير,المالك,Owner 🎖} بس " end
...
[Could](https://t.me/MJJJ4)

➥ [مطور السورس](https://t.me/XzzzU)
➥ [Source Nostra](https://t.me/XzzzU)
...
if not msg.Kara then return "• **هذا الامر يخص {المنشئ الاساسي,Owner 🎖} فقط ." end
...
if not msg.Kara then return "*•* هذا الامر يخص {المالك,المطور,Owner 🎖} بس  " end
...
if not msg.Kara then return "*•* هذا الامر لــ {المالك,المطور,Owner 🎖} بس  " end
...
if not msg.Admin then return sendMsg(msg.chat_id_,msg.id_,"*•* هذا الامر يخص {الادمن,المدير,المالك,Owner 🎖} بس") end
...
elseif msg.SudoUser and Text== "تحبني" or Text=="تحبني" then 
 return sendMsg(msg.chat_id_,msg.id_,"لا احب انس")
...
• [اضغط هنا هنا عندنا لك مفاجأة](https://t.me/Qx77bot)  
